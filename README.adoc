...
. In the *Project Data* section, set the value of the *Artifact* field to `springboot`.
...
Then restart the application. You can do this by using the Stop and Restart buttons in the dialog towards the top of the Editor:
